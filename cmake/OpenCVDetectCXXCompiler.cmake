...
if(NOT HAVE_CXX14)
  ocv_check_compiler_flag(CXX "" HAVE_CXX14 "${OpenCV_SOURCE_DIR}/cmake/checks/cxx11.cpp")
  if(NOT HAVE_CXX14)
    ocv_check_compiler_flag(CXX "-std=c++14" HAVE_STD_CXX14 "${OpenCV_SOURCE_DIR}/cmake/checks/cxx11.cpp")
    if(HAVE_STD_CXX14)
...
if(HAVE_CXX14 AND (X86 OR X86_64))
...
if((HAVE_CXX14 AND OPENCV_ENABLE_ATOMIC_LONG_LONG
        AND NOT MSVC
...
else(HAVE_CXX14 AND OPENCV_ENABLE_ATOMIC_LONG_LONG)
